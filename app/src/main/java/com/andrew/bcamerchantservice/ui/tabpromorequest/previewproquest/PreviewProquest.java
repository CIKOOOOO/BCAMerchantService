package com.andrew.bcamerchantservice.ui.tabpromorequest.previewproquest;
...
import com.andrew.bcamerchantservice.ui.tabpromorequest.promorequest.PromoAdapter;
        ...
        if (bundle != null) {
            if (bundle.getParcelable(PROQUEST_GET_DATA) != null) {
                ...
                if (promoTransaction != null) {
                    ...
                    tvDate.setText(Utils.getTime(pattern) + " WIB");
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                childRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        map.put("dateRequest", Utils.getTime("dd/MM/yyyy"));
                        map.put("timeRequest", Utils.getTime("HH:mm"));
