...
import com.andrew.bcamerchantservice.db.sqlite.PromoSQLite;
import com.andrew.bcamerchantservice.db.sqlite.PromoStuffSQLite;
import com.andrew.bcamerchantservice.model.PromoForm;
import com.andrew.bcamerchantservice.model.PromoTransaction;
 ...
 */
public class PromoRequest extends Fragment implements PromoAdapter.onDelete, TemplateAds.onClick
        , View.OnClickListener, View.OnTouchListener, MainActivity.onBackPressFragment {
    ...
    private void initVar() {
        ...
        Log.e("asd", prefConfig.getPrefID() + "");
    }
